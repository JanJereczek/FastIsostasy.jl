# FastIsostasy.jl — Agent Rules

## Project Overview

FastIsostasy.jl is a Julia package for fast, friendly, flexible, computation of regional glacial isostatic adjustment (GIA) on CPUs and GPUs.

## Language & Environment

- **Julia 1.12+** | CPU and GPU (CUDA, AMD, Metal, OneAPI)
...
```
src/
├── FastIsostasy.jl            # Main module, exports
